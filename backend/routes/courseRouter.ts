...
import { uploadFilesAndCreateCourse,getAllCourses,updateCourse,deleteCourse,getASingleCourse,getAllInstructorCourses,getCategories} from "../controllers/courseController";
